...
# NOTE: You might want to remove this if protoc-gen-go-temporal is not hosted on GitHub releases.
...
download_release() {
	...
	# TODO: Adapt the release URL convention for protoc-gen-go-temporal
...
install_version() {
	...
	(
		...
		# TODO: Assert protoc-gen-go-temporal executable exists.
		local tool_cmd
